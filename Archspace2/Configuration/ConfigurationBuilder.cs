...
namespace Archspace2
{
    public class ConfigurationBuilder
    {
        ...
        public ConfigurationBuilder AddArmor(Armor armor) { Configuration.Armors.Add(armor); return this; }
        public ConfigurationBuilder AddComputer(Computer computer) { Configuration.Computers.Add(computer); return this; }
        public ConfigurationBuilder AddDevice(Device device) { Configuration.Devices.Add(device); return this; }
        public ConfigurationBuilder AddEngine(Engine engine) { Configuration.Engines.Add(engine); return this; }
        public ConfigurationBuilder AddEvent(Event @event) { Configuration.Events.Add(@event); return this; }
        public ConfigurationBuilder AddPlanetAttribute(PlanetAttribute planetattribute) { Configuration.PlanetAttributes.Add(planetattribute); return this; }
        public ConfigurationBuilder AddProject(Project project) { Configuration.Projects.Add(project); return this; }
        public ConfigurationBuilder AddRace(Race race) { Configuration.Races.Add(race); return this; }
        public ConfigurationBuilder AddShield(Shield shield) { Configuration.Shields.Add(shield); return this; }
        public ConfigurationBuilder AddShipClass(ShipClass shipclass) { Configuration.ShipClasses.Add(shipclass); return this; }
        public ConfigurationBuilder AddSpyAction(SpyAction spyaction) { Configuration.SpyActions.Add(spyaction); return this; }
        public ConfigurationBuilder AddTech(Tech tech) { Configuration.Techs.Add(tech); return this; }

        public ConfigurationBuilder AddArmors(IEnumerable<Armor> armors) { Configuration.Armors.AddRange(armors); return this; }
        public ConfigurationBuilder AddComputers(IEnumerable<Computer> computers) { Configuration.Computers.AddRange(computers); return this; }
        public ConfigurationBuilder AddDevices(IEnumerable<Device> devices) { Configuration.Devices.AddRange(devices); return this; }
        public ConfigurationBuilder AddEngines(IEnumerable<Engine> engines) { Configuration.Engines.AddRange(engines); return this; }
        public ConfigurationBuilder AddEvents(IEnumerable<Event> events) { Configuration.Events.AddRange(events); return this; }
        public ConfigurationBuilder AddPlanetAttributes(IEnumerable<PlanetAttribute> planetattributes) { Configuration.PlanetAttributes.AddRange(planetattributes); return this; }
        public ConfigurationBuilder AddProjects(IEnumerable<Project> projects) { Configuration.Projects.AddRange(projects); return this; }
        public ConfigurationBuilder AddRaces(IEnumerable<Race> races) { Configuration.Races.AddRange(races); return this; }
        public ConfigurationBuilder AddShields(IEnumerable<Shield> shields) { Configuration.Shields.AddRange(shields); return this; }
        public ConfigurationBuilder AddShipClasses(IEnumerable<ShipClass> shipclasses) { Configuration.ShipClasses.AddRange(shipclasses); return this; }
        public ConfigurationBuilder AddSpyActions(IEnumerable<SpyAction> spyactions) { Configuration.SpyActions.AddRange(spyactions); return this; }
        public ConfigurationBuilder AddTechs(IEnumerable<Tech> techs) { Configuration.Techs.AddRange(techs); return this; }

        public ConfigurationBuilder UseDefaultArmors()
        {
        ...
        public ConfigurationBuilder UseDefaultComputers()
        {
            Configuration.Computers = new List<Computer>()
            {
                new Computer()
                {
        ...
        public ConfigurationBuilder UseDefaultDevices()
        {
        ...
        public ConfigurationBuilder UseDefaultEngines()
        {
            Configuration.Engines = new List<Engine>()
            {
                new Engine()
                {
                    Id = Engines.Retro,
        ...
        public ConfigurationBuilder UseDefaultEvents()
        {
            Configuration.Events = new List<Event>()
            {
                new Event()
                {
                    Id = 1200,
        ...
        public ConfigurationBuilder UseDefaultPlanetAttributes()
        {
            Configuration.PlanetAttributes = new List<PlanetAttribute>()
            {
                new PlanetAttribute()
                {
                    Id = 10000,
        ...
        public ConfigurationBuilder UseDefaultProjects()
        {
            Configuration.Projects = new List<Project>()
            {
                new Project()
                {
                    Id = 7002,
        ...
        public ConfigurationBuilder UseDefaultRaces()
        {
            Configuration.Races = new List<Race>()
            {
                new Race()
                {
                    Id = Races.Human,
        ...
        public ConfigurationBuilder UseDefaultShields()
        {
            Configuration.Shields = new List<Shield>()
            {
                new Shield()
                {
        ...
        public ConfigurationBuilder UseDefaultShipClasses()
        {
            Configuration.ShipClasses = new List<ShipClass>()
            {
                new ShipClass()
                {
        ...
        public ConfigurationBuilder UseDefaultSpyActions()
        {
            Configuration.SpyActions = new List<SpyAction>()
            {
                new SpyAction()
                {
        ...
        public ConfigurationBuilder UseDefaultTechs()
        {
            Configuration.Techs = new List<Tech>()
            {
                new Tech()
                {
                    Id = 1101,
        ...
        public ConfigurationBuilder UseDefaultWeapons()
        {
            Configuration.Weapons = new List<Weapon>()
            {
                new Weapon()
                {
                    Id = Weapons.Laser,
        ...
        public ConfigurationBuilder UseDefaults()
        {
            return 
                UseDefaultArmors()
                .UseDefaultComputers()
